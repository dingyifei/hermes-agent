...
RUN apt-get update && \
    ...
    ca-certificates curl gnupg iputils-ping python3 python-is-python3 ripgrep ffmpeg gcc python3-dev libffi-dev procps git openssh-client docker-cli xz-utils && \
